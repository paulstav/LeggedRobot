...
#define BRD_IP "147.102.100.131"

#include "ros/ros.h"
#include "motor_control/FR_Encoder.h"
#include "motor_control/FR_PWM.h"
...
void pwmCallback(const motor_control::FR_PWM::ConstPtr& msg)
{
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "FR_motor_controller");
  ros::NodeHandle n;
  ros::Publisher motor_controller_pub = n.advertise<motor_control::FR_Encoder>("FR_encoder_feedback", 1000);
  ...
  while (ros::ok())
  {
     ...
     */
    motor_control::FR_Encoder encoder_msg;
    ...
    if(gotMsg){
      ...
      motor_controller_pub.publish(encoder_msg);
	  if(msg_count >= 5000)
	  {
		msg_count = 0;
