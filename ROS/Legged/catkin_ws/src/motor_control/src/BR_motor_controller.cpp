...
void pwmCallback(const motor_control::BR_PWM::ConstPtr& msg)
{
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "BR_motor_controller");
  ros::NodeHandle n;
  ros::Publisher motor_controller_pub = n.advertise<motor_control::BR_Encoder>("BR_encoder_feedback", 1000);
