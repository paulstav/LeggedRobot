...
void pwmCallback(const motor_control::BL_PWM::ConstPtr& msg)
{
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "BL_motor_controller");
  ros::NodeHandle n;
  ros::Publisher motor_controller_pub = n.advertise<motor_control::BL_Encoder>("BL_encoder_feedback", 1000);
