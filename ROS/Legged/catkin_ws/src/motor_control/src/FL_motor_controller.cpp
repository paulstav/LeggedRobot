...
void pwmCallback(const motor_control::FL_PWM::ConstPtr& msg)
{
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "FL_motor_controller");
  ros::NodeHandle n;
  ros::Publisher motor_controller_pub = n.advertise<motor_control::FL_Encoder>("FL_encoder_feedback", 1000);
