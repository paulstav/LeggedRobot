...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle n;
  ros::Publisher motor_controller_pub = n.advertise<motor_control::Encoder>("encoder_feedback", 1000);
  ros::Subscriber motor_pid_sub = n.subscribe("pwm_feedback", 1000, pwmCallback);
  ...
  ROS_INFO("Staring communication with Tiva board.");
  while (ros::ok())
  {
    /**
