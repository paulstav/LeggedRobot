...
void encoderCallback(const motor_control::FR_Encoder::ConstPtr& msg)
{
...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle n;
  ros::Publisher motor_pid_pub = n.advertise<motor_control::FR_PWM>("FR_pwm_feedback", 1000);
