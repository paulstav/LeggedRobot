...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name legged_robot-msg:<Position> is deprecated: use legged_robot-msg:Position instead.")))

(cl:ensure-generic-function 'desiredPos-val :lambda-list '(m))
(cl:defmethod desiredPos-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader legged_robot-msg:desiredPos-val is deprecated.  Use legged_robot-msg:desiredPos instead.")
  (desiredPos m))
