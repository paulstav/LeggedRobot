...
(cl:defmethod cl:initialize-instance :after ((m <PWM>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PWM)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name legged_robot-msg:<PWM> is deprecated: use legged_robot-msg:PWM instead.")))

(cl:ensure-generic-function 'pwm_duty-val :lambda-list '(m))
(cl:defmethod pwm_duty-val ((m <PWM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader legged_robot-msg:pwm_duty-val is deprecated.  Use legged_robot-msg:pwm_duty instead.")
  (pwm_duty m))
